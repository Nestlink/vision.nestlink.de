<script lang="ts">
	import {
		PUBLIC_LEGAL_ADDRESS_CITY,
		PUBLIC_LEGAL_ADDRESS_COUNTRY,
		PUBLIC_LEGAL_ADDRESS_STREET,
		PUBLIC_LEGAL_ENITIY
...
<p>
	{PUBLIC_LEGAL_ENITIY}<br />
	{PUBLIC_LEGAL_ADDRESS_STREET}<br />
	{PUBLIC_LEGAL_ADDRESS_CITY}<br />
	{PUBLIC_LEGAL_ADDRESS_COUNTRY}
</p>
...
<p>
	Bei einem Besuch unserer Webseite können Protokolldaten, sogenannte Server-Logfiles an uns oder
	unseren Webhoster übertragen werden. Zu den protokolldaten können unter anderem der Name der
	aufgerufenen Seite, ein Zeitstempel, die IP-Adresse, die übertragene Datenmenge sowie auch der
	anfragende Provider gehören. Die Verarbeitung erfolgt auf Grundlage des Art. 6 Abs. 1 lit. f DSGVO
	aus unserem überwiegenden berechtigten Interesse an der Gewährleistung eines störungsfreien
